...
HD_PWD='/root/Desktop/LOG_FPGA/XSA_scripts/sample_testcase/fpga_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_adder.tcl
