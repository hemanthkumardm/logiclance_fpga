...
HD_PWD='/root/Desktop/LOG_FPGA/XSA_scripts/sample_testcase/fpga_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_adder.tcl -notrace
